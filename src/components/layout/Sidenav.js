    ...
    <>
      ...
      <hr />
          <Menu theme="light" mode="inline">
            ...
            <Menu.Item key="2">
                  <NavLink to="/addPayment">
                        <span
                          className="icon"
                          style={{
                            background: page === "addPayment" ? color : "",
                          }}
                        >
                          {addPayment}
                        </span>
                        <span className="label">Add Payment</span>
                  </NavLink>
            </Menu.Item>
            ...
            <Menu.Item key="3">
                  <NavLink to="/userDetails">
                        <span
                          className="icon"
                          style={{
                            background: page === "userDetails" ? color : "",
                          }}
                        >
                          {userDetails}
                        </span>
            ...
            <Menu.Item key="4">
              <NavLink to="/paymentHisotry">
                    <span
                      className="icon"
                      style={{
                        background: page === "paymentHistory" ? color : "",
                      }}
                    >
                      {paymentHistory}
                    </span>
